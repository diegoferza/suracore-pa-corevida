...
import com.sura.pruebascorevida.utils.enums.OperadorLogico;
...
public class Utilidad {
  ...
  public static boolean compararValores(int numero1, int numero2, String operadorLogico) {
    if (OperadorLogico.MAYOR.getValor().equalsIgnoreCase(operadorLogico)) {
      return numero1 > numero2;
    }
    if (OperadorLogico.MENOR.getValor().equalsIgnoreCase(operadorLogico)) {
      return numero1 < numero2;
    }
    if (OperadorLogico.IGUAL.getValor().equalsIgnoreCase(operadorLogico)) {
      return numero1 == numero2;
    }
    return false;
  }
